---
title: The Shortened Watch Failure
status: adopted-history
adopted_in: KALSA-021
tags:
  - event
  - language
  - measures
...
The Shortened Watch Failure is an adopted post-Fall public-works disaster. This note alone owns its factual sequence, damage, inquiry, and settlement. [[Foundations/Language and Reckoning|Language and Reckoning]] owns the general linguistic and numerical inheritance; [[Institutions/High Lojban and Descendant Speech|High Lojban and Descendant Speech]] owns teaching, translation, and notice practice; [[Institutions/Measures, Formulae, and Machine Speech|Measures, Formulae, and Machine Speech]] owns conversion, certification, and machine-facing procedure.
...
- Date, polity, reservoir, downstream district, and relationship to named Crown Cities.
- Exact inherited interval, local watch length, notation, pronunciation, and conversion method.
- Names and offices of the clerk, managers, operator, reviewers, and worker representatives.
- Number and identity of injured workers, damage, compensation, and surviving claims.
- Whether the reservoir remains active and where its records are held.
- Which later jurisdictions adopted the settlement's procedures or merely cite the story.
