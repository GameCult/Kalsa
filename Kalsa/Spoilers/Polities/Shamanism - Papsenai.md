...
- Tribal membership, land tenure, inheritance, intertribal authority, and current polity-wide offices.
- Whether the Alliance exists; if adopted, its members, founding chronology, exact obligations, and the Intuition polity's protective role.
- The difference, if any, between the seed's “druids” and shamans.
- Limits of bonding consent and curse law outside named institutions.
- Current city and people naming, including the exact translation of Ti'asantatca.
- Which technologies or relics, if any, presently support agriculture or the stormshield.
