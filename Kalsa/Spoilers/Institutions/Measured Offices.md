...
[[Spoilers/Events/The Santabi'u Silt Appeal|The Santabi'u Silt Appeal]] alone owns the factual event. Its administrative consequence is that a public-work model must preserve boundary, worker observations, omitted dependencies, and review horizon when it becomes a levy or allocation decision. Petitions cannot return only to the office whose revenue depends on rejecting them; client copies and a superior appeal path are part of the live system.
