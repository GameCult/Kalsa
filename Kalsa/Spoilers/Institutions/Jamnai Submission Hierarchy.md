---
title: Jamnai Submission Hierarchy
aliases:
...
- Native names and exact powers of summit, branch, champion, registrar, and technical offices.
- Which obligations are hereditary and which require renewal.
- Current standards for recognized challenge, appeal, compensation, sanctuary, and restoration.
- Whether any body outside the hierarchy can review a summit decision.
- Arcology layout, output, current custodians, and the technical basis of the Ash-Valve precedent.
- The current number, size, and autonomy of external tributaries.
- How Jamnai law treats people carrying several Gifts or divine bindings.

See [[Spoilers/Polities/Sorcery - Jamnai and the Terjamna|Jamnai and the Terjamna]], [[Spoilers/Institutions/Soiru'i Sects|Soiru'i Sects]], [[Spoilers/Institutions/The Potential Economy|The Potential Economy]], and [[Spoilers/Institutions/God-Cult Covenants|God-Cult Covenants]].
