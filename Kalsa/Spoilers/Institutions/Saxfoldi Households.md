...
- Native household terms, membership rites, decision practices, and the range of kinship forms.
- Exact limits and learned techniques of Sarxe communal communication.
- Common treatment of personal goods, household shares, dependent support, and departure claims.
- Whether route, cache, and campsite claims receive recognition from particular neighboring polities.
- The prevalence and authority of mediators, advocates, store holders, and route keepers.
- How static Sarxe households differ from mobile Saxfoldi households.
