---
title: Ji'esti Flight and Refuge
aliases:
  - Sarxe flight law
  - Ji'esti refuge
...
Copies separate identification from route exposure. A host refuge may need to know who entered and what care is required without learning where [[Polities/Channeling - Sarxe|Saxfoldi]] will move next. A recovery party may carry a description and last-seen place without holding the destination of surviving kin. No one record should expose every person, route, cache, and claim.
...
- a relic follows [[Institutions/Relic Custody|Relic Custody]], not the search sponsor's appetite;
...
- Native names, offices, signals, record forms, and review bodies used in flight and refuge.
- Current refuge sites, allied safe passages, host agreements, and relations with Ju'onai and Terjamna authorities.
- Evidence and remedies for denied admission, wrongful confinement, lost children, coerced labor, and disclosed routes.
- Rights of return, restitution, burial, archive access, and political restoration at the original Crown or static Saxfoldi.
- The form and timing of Ji'esti commemoration.
- What present Sarxe institutions know about the Soiru'i beacon and whether any comparable threat remains.
