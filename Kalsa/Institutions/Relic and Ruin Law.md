...
The governing distinction is simple: entry into a place does not empty the place of prior authority. [[Dungeons/Dungeon Provenance|Provenance]] identifies the layers and claims present. Law decides which actor may do what while those layers remain contested.
...
A delving party owns only the expedition rights granted by the local authority and the obligations agreed in its [[Institutions/Delving Compacts|compact]]. It may acquire possession through recovery. It receives title only to residual movable salvage that remains after prior claims, active dependencies, custody restrictions, remains, and hazard costs have been addressed under the governing jurisdiction.
...
- The ruin-law traditions and enforcement capacity of particular polities.
- Which authorities recognize foreign custody, compact, and provenance records.
- Rules for ruins crossing borders or serving communities in several jurisdictions.
- Penalties, limitation periods, evidentiary standards, and appeal forms.
- Which hazards justify destruction rather than containment or continued study.
- Whether any polity recognizes a possible machine or simulation claimant before personhood is settled.
