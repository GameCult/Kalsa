...
Analysis is an input to administration, not its sovereign. [[Foundations/Kaos|Kaos]] owns the magical faculty and uncertainty. [[Institutions/Ju'onai Examiners|Ju'onai Examiners]] own bounded certification. This institution owns office, allocation, intervention, record, petition, and remedy.
...
| Certification | [[Institutions/Ju'onai Examiners|Examiners]] | Appointment or policy |
| Relic configuration and safe operation | [[Institutions/Relic Custody|The relevant custodian]] | Allocation of safely available output |
...
## Portfolios rather than universal cleverness
...
An office consists of charter, seal or recognized authority, staff, archives, current obligations, stores, budget, dependencies, unresolved petitions, and interventions in progress. The holder owns decisions within that scope. Clerks and custodians preserve the state that makes those decisions reviewable.
...
3. [[Institutions/Ju'onai Examiners|Examiners]] verify any required domain certificate without appointing the successor;
...
Emergency continuity can become quiet usurpation. An acting keeper who controls the archive and budget may starve rivals until appointment looks inevitable. Duplicate petition rolls and a fixed review date are the main restraints.

Families reproduce office through preparation, archives, patronage, divine affiliation, and familiarity with administrative language. The absence of a hereditary title does not make succession open.

## Records

The administration's power rests on records that let one office act upon a system too broad to perceive at once.

Core records include:

- charter and authority boundary;
- territory and dependency maps;
- tax-capacity observations and actual collections;
...
No record is the territory. A tax roll can omit a household; a canal map can omit a lateral; a divine classification can erase a dissident practice; an archive can be internally consistent because everyone harmed by it lacks writing access.

Clerks therefore preserve marginal notes, rejected petitions, worker observations, and later outcomes rather than only final orders. A superior who receives only clean summaries inherits the subordinate's blind spot as official fact.

Secrecy may protect military routes, vulnerable infrastructure, personal records, or an active investigation. It does not justify hiding an office boundary, tax basis, known public hazard, or existence of a petition from the person burdened by the decision.
...
- Which unit is counted: household, field, workshop, route, office, or client polity?
- Is an infrastructure improvement a local gain, an imperial investment, or new taxable capacity?
- Which losses and maintenance burdens reduce the levy?
...
An Analyst may identify a leverage point. Engineers, workers, growers, carriers, and local keepers supply practice. [[Institutions/The Techpriesthoods|Techpriests]] and [[Institutions/Relic Custody|relic custodians]] may stop unsafe work on an entrusted Ark configuration. Client authorities may retain land, water, labor, or ritual claims.

A defensible intervention record states:

- the public outcome sought;
- the system boundary and people treated as dependents;
- observed inputs and missing observations;
- technical owner and worker witnesses;
- expected gain, transferred risk, and stop condition;
...
Appeal goes to the superior portfolio or an office commissioned to review that class of decision. Examination procedure can be referred separately to [[Institutions/Ju'onai Examiners|Examiners]]. A superior may affirm policy while revoking the certificate used to justify it, or preserve a certificate while finding the office exceeded its charter.

Grounds include:

- the office acted outside its portfolio;
...
- remedy corrected the model but not the harm.

Officials, clerks, workers, and custodians may refuse to falsify a record or perform an unsafe act. Refusal should name the boundary crossed and preserve evidence. The Hegemony may protect such refusal because reliable administration needs it. Patrons may punish it because reliable administration threatens them.

Restoration can include returned goods, reduced levy, repair, reinstatement, corrected certificate, public record, compensation, or recognition of preserved local authority. No universal schedule exists. A state that corrects its ledger without restoring the person has repaired its model, not its promise.

## Client and occupied polities

The Hegemony prefers clients it can model and tax through existing authority. A compact may preserve local courts, land tenure, worship, language, succession, and work offices while granting tribute, records, passage, garrison, examination, or public-work rights to Ju'onai portfolios.

This arrangement gives local people continuity and local elites leverage. It also makes those elites collection organs. A client ruler can blame imperial metrics for a levy they helped design; an imperial officer can call local coercion autonomous custom while counting its output.

The administration classifies client territory into comparable categories. Comparison can expose abusive local collection and coordinate relief. It can also flatten different obligations into a common tax unit and make cultural translation look like discovery of an underlying order.

Resistance preserves what the compact did not cede: local archives, duplicate measures, worker guilds, cult authority, household claims, rival schools, and the right to force the Hegemony to name its intervention. Concealment and falsified production are also common. They protect survival and can shift levy onto neighbors with less power to hide.

The annexed Channeler Crown and tributary Prophetic City show different limits. Sarxe communication and mobility resist reduction to individual office records. Prophetic forecasts change when administrative plans become known. The Hegemony remains powerful because it adapts; its clients remain political because adaptation is never the same as total ownership.
...
- only the easily counted becomes visible;
- people learn to optimize the measure rather than the public outcome;
- a successful intervention is used outside the system that made it successful;
- occupied categories are translated into imperial ones and the mismatch disappears from the report;
- high-rank disagreement is preserved while low-rank observation is summarized away;
- divine hierarchy makes the preferred concept feel prior to the evidence;
- technical or social harms appear after the office's review horizon ends.

The Hegemony can analyze its own failures. It can also promote the official who produces the most elegant explanation for why no alternative was possible.

## The Santabi'u Silt Appeal

[[Events/The Santabi'u Silt Appeal|The Santabi'u Silt Appeal]] alone owns the factual event. Its administrative consequence is that a public-work model must preserve boundary, worker observations, omitted dependencies, and review horizon when it becomes a levy or allocation decision. Petitions cannot return only to the office whose revenue depends on rejecting them; client copies and a superior appeal path are part of the live system.

Administrative remedy must reach the consequence the office owned: levy, held stores, clearance, local participation, and damaged livelihood. Narrowing an examination certificate is necessary evidence, not compensation by itself.

## Resistance

Resistance takes analytical and non-analytical forms:

- preserve local measures and compare them with imperial rolls;
- copy petitions before filing;
- train low-expression clerks and public exam candidates;
- invoke the exact boundary of a portfolio or client compact;
...
Dungeon recovery does not let analysis swallow [[Institutions/Relic Custody|custody]], site authority, worker knowledge, or possible personhood inside the relic.
...
The institution is useful where it makes consequence inspectable across scale. It becomes domination when inspectability flows upward and intervention flows down.

## Unresolved

- Native names, tiers, jurisdictions, and current summit of the administration.
- Exact relation among administrative office, divine hierarchy, lineage, and examination rank.
- Tax forms, currencies, provincial boundaries, client compacts, and citizenship.
- Independent review, public archive access, compensation, and enforcement of restoration.
- Which public works and relic systems the Hegemony currently operates.
...
See [[Polities/Analysis - Ju'onai Hegemony|Ju'onai Hegemony]], [[Institutions/Ju'onai Examiners|Ju'onai Examiners]], [[Institutions/The Potential Economy|The Potential Economy]], and [[Institutions/God-Cult Covenants|God-Cult Covenants]].
