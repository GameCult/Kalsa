...
The strongest shared regularities come from accumulated failure rather than one
uncontested theory. Work records say a storm cannot be divided on an empty sky
and a wall does not yield where no load reaches it. Delving compacts budget
people, tools, food, shelter, and recovery because inspiration has never made
those costs imaginary. Court records preserve miracles that interfered with one
another. Shrine and mortuary keepers warn that repeated great workings near old
...
Visible effect is not complete explanation. Ju'onai schools call some local
causal scars **aftermarks**, then dispute what could have produced them; even
their strictest accounts refuse to let the mark identify an actor or intention
