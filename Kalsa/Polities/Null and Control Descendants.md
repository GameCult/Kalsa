---
title: Null and Control Descendants
aliases:
  - Control population
  - Null populations
status: preservation-stub
source_witness:
...
Control bloodlines mixed widely with Ring descendants. Present Null people are not all Controls, and present Control descendants are not necessarily Null. [[Foundations/Magic Styles|Null]] names the absence of an expressed Gift, not a race, caste, religion, or political loyalty.
...
See [[Polities/Spokers|Spokers]], [[Foundations/Prometheus|Prometheus]], and [[Foundations/Ark and Fall|Ark and Fall]].
