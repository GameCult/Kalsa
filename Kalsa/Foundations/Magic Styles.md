...
Prometheus arranged the seven Gifts through a development sequence. Each also has a binary Kaos signature derived from [[Foundations/Kaos#Three axes|Depth, Clarity, and Scope]]. These systems answer different questions and must not be collapsed.

| Sequence | Signature | Style | Axes | God-foundation | Seed polity or culture |
|---|---:|---|---|---|---|
| N | 000 | Null | none | no | [[Polities/Null and Control Descendants|Control descendants]]; many [[Polities/Spokers|Spokers]] |
| I | 001 | Luck | Scope | yes | [[Polities/Luck - Selza'a|Selza'a]] |
| II | 100 | Sorcery | Depth | yes | [[Polities/Sorcery - Jamnai and the Terjamna|Terjamna of Jamnai]] |
| III | 101 | Shamanism | Depth, Scope | no | [[Polities/Shamanism - Papsenai|Papsenai]] |
| IV | 010 | Analysis | Clarity | yes | [[Polities/Analysis - Ju'onai Hegemony|Junsenai of the Ju'onai Hegemony]] |
| V | 011 | Prophecy | Clarity, Scope | no | [[Polities/Prophecy - The Divided City|Divided City of Prophets]] |
| VI | 110 | Channeling | Depth, Clarity | no | [[Polities/Channeling - Sarxe|Sarxe]] |
| VII | 111 | Intuition | Depth, Clarity, Scope | no | [[Polities/Intuition - Unresolved|unresolved polity]] |
...
Each style exposes different evidence. See [[Foundations/Kaos#Observing Kaos|Observing Kaos]]. Luck cannot be directly detected; prophecy can only infer its bias. Analysis reads altered systems, prophecy reads deformed forecasts, channeling reads active flows, and shamanism reads pressure on a bonded target.
