...
A God Beast's collapse can leave a magical fountain where old ghosts and dead powers manifest while potential remains available. Divine warfare, failed succession, mass death, or repeated miracle use can also make one place a feeding ground for [[Foundations/Projections, God Beasts, and Thaumavores#Thaumavores|thaumavores]]. Such a wound may overlay an Ark site, battlefield, tomb, temple, or ordinary settlement.

“Nest” is a field description for recurrent manifestations around a source of potential. It does not establish a species, shared purpose, or permanent home. Some presences may be predators. Others may be ancestors, omitted casualties, unascended Beasts, or claimants using the only interval in which they can be heard. [[Institutions/Death and Binding Law|Death and Binding Law]] owns mortal procedure around those claims.
...
- The names and extent of particular dungeon complexes.
- The distribution of Ring, Spoke, hub, and drive-core wreckage after the Fall.
- Which evolutionary arenas or terraforming works remain active.
- Common provenance standards across Techpriesthoods and polities.
- Whether any Posthuman simulation, Promethean process, or virtual arena can leak into present sites.
- How reliably manifestations can be tied to one death, God Beast, hierarchy, or historical layer.
