...
# KALSA-019 — The Ashen Intake

## Objective

Repair custodian formation and succession while proving the institutional machinery can generate a concrete, immediately playable Ghostlight dungeon.
...
The Grey Scald anchors contested removal, emergency custody, unsupported succession, public/technical interval conflict, death claims, and records left below. The launch begins at a controlled drained basin with three shutters remaining and composes language, formula, cult/kin, custody, compact, and settlement pressure. It reveals no simulation truth and creates no universal relic law.

## Verification

- [x] Seed hashes unchanged.
- [x] Touched links and frontmatter resolve.
- [x] Direct-entry dungeon rubric and custodian lifecycle pass.
