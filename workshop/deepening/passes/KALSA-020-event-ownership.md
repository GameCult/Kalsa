...
# KALSA-020 — Event Ownership

## Objective

Stop named adopted events from forking across polity and institution notes or masquerading as claims found in the seed.
...
This pass adopts no new event facts beyond reconciling the common sequence already repeated across each cluster. It deletes six duplicate factual narratives, preserves attributed interpretations, and gives future correction one owner.

## Verification

- [x] All touched and global links resolve.
- [x] Seed witnesses remain byte-identical.
- [x] Event ownership and adoption metadata pass.
